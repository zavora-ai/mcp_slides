...
- [ ] 1. Phase 0 — Scaffold engine workspace and prove a valid blank deck
  - [ ] 1.1 Create the `zavora-slide` Cargo workspace
  ...
  - [ ] 1.2 Implement `zavora-slide-opc` (fork zavora-docx-opc)
  ...
  - [ ] 1.3 Model the minimum PresentationML parts in `zavora-slide-oxml`
  ...
  - [ ] 1.4 Implement `Presentation::new()` / `save()` / `save_to_buffer()` in `zavora-slide`
...
- [ ] 2. Phase 0 — Scaffold `slides-mcp` server with lifecycle tools
  - [ ] 2.1 Create the server crate
  ...
  - [ ] 2.2 Implement `PresentationStore` in `store.rs`
  ...
  - [ ] 2.3 Implement response/error infrastructure
  ...
  - [ ] 2.4 Implement lifecycle + discovery tools in `server.rs`
...
- [ ] 3. Phase 1 — Text authoring (engine)
  - [ ] 3.1 Model DrawingML text body + placeholders in `-oxml`
...
- [ ] 4. Phase 1 — Text authoring (server tools)
  - [ ] 4.1 Slide tools
  ...
  - [ ] 4.4 Read tools + manifest + checkpoint
...
- [ ] 6. Phase 3 — Rendering and export
  - [ ] 6.1 Implement `zavora-slide-layout`
    ...
    - _Requirements: 9.3_
  - [ ] 6.2 Implement `zavora-slide-render` (PNG + SVG)
  ...
  - [ ] 6.3 Implement `zavora-slide-pdf`
    - One page per slide; `Presentation::save_pdf`
    - _Requirements: 9.2_
  - [ ] 6.4 Server: enable export tools + CLI
...
- [ ] 7. Phase 4 — Deck templates and UI substrate
  - [ ] 7.1 Implement `business:*` deck templates
